...
#else
    envPath= "D:/文档/项目文件/软件/DVCC/DVCC模拟环境/版本发布/version 1.4.2.2/resource/file_resource";
#endif
...
#else
    QDir dir("D:/文档/项目文件/软件/DVCC/DVCC模拟环境/版本发布/version 1.4.2.2/resource/file_resource/theme/");
#endif
...
{
    QDesktopServices::openUrl(QUrl("https://harleyehrich.github.io/product/dvcc/dvcc_index.html"));
}
...
void MainWindow::on_am_app_version_info_triggered()
{
    ...
    a.setText(tr("<h2>Version 1.4.2.3</h2>"
                 "<h2>Updata time 2022-4-18</h2>"
