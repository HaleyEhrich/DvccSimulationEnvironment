#ifndef INPUTQGITEM_H
#define INPUTQGITEM_H
...
//#define inputBodyPen QPen(QColor(103, 158, 210),2)
//#define inputBodyBrush QBrush(QColor(103, 158, 210))
...
class InputQGItem : public QGraphicsItem
{
private:
...
public:
    ...
    InputQGItem(systemDataSet* dataSet,QGraphicsItem *parent = 0);
};
