...
//#define registerBodyPen QPen(QColor(103, 158, 210),2)
//#define registerBodyBrush QBrush(QColor(103, 158, 210))
...
class R1QGItem : public QGraphicsItem
{
private:
...
public:
    ...
    R1QGItem(systemDataSet* dataSet,QGraphicsItem *parent = 0);
};
#endif // R1QGITEM_H
