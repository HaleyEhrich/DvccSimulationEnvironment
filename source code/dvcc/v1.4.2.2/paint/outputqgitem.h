#ifndef OUTPUTQGITEM_H
#define OUTPUTQGITEM_H
...
//#define outputBodyPen QPen(QColor(103, 158, 210),2)
//#define outputBodyBrush QBrush(QColor(103, 158, 210))
...
class OutputQGItem: public QGraphicsItem
{
private:
...
public:
    ...
    OutputQGItem(systemDataSet* dataSet,QGraphicsItem *parent = 0);
};

#endif // OUTPUTQGITEM_H
